...
const Offers = () => {
  const offers = [
    ...
    },
    {
      ...
      description: "Enjoy a 3-night stay for the whole family with complimentary dinner.",
      price: "₹10000 for 3 nights",
      validity: "Valid for the holiday season"
    },
    {
      title: "Corporate Stay",
      description: "For business travelers, get 10% off on a minimum stay of 2 nights..",
      price: "₹2,499/night",
